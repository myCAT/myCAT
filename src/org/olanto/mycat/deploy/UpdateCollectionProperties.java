...
import org.olanto.idxvli.server.SetCollectionProperties;

/**
 * mise à jour des collections.
 */
public class UpdateCollectionProperties {
    ...
    public static void main(String[] args) {
        ...
        SetCollectionProperties.updateCollectionProperties(idxsrv);
